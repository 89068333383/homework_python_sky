...
def test_add_to_cart(driver):
    ...
    search_results.attach_screenshot(
        "Скриншот: Товар добавлен в корзину (модалка видна)"
    )
...
@allure.story("Добавление товара в корзину")
@allure.title(
    "Тест: проверка невозможности добавления более 2-х товаров для физического лица"
)
